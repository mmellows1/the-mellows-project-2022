import { faCss3Alt, faElementor, faHtml5, faMicrosoft, faWordpress } from "@fortawesome/free-brands-svg-icons";
...
const Genistar = () => {
    const content = {
        ...
        languageIcons: [faHtml5, faCss3Alt, faWordpress, faMicrosoft],
        content: {
